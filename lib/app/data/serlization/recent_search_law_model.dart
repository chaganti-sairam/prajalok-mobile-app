...
class RecentSearchModel {
  ...
  factory RecentSearchModel.fromRawJson(String str) =>
...
class Response {
  ...
  factory Response.fromJson(Map<String, dynamic> json) => Response(
        laws: json["laws"] == null
            ? []
            : List<Law>.from(json["laws"]!.map((x) => Law.fromJson(x))),
        title: json["title"],
      );
  ...
  Map<String, dynamic> toJson() => {
        "laws": laws == null
            ? []
            : List<dynamic>.from(laws!.map((x) => x.toJson())),
        "title": title,
      };
}
...
class Law {
  ...
  factory Law.fromJson(Map<String, dynamic> json) => Law(
        ...
        relatedLaws: json["related_laws"] == null
            ? []
            : List<RelatedLaw>.from(
                json["related_laws"]!.map((x) => RelatedLaw.fromJson(x))),
        lawKeyPoints: json["law_key_points"] == null
            ? []
            : List<String>.from(json["law_key_points"]!.map((x) => x)),
      );

  Map<String, dynamic> toJson() => {
        "law_name": lawName,
        "law_summary": lawSummary,
        "related_laws": relatedLaws == null
            ? []
            : List<dynamic>.from(relatedLaws!.map((x) => x.toJson())),
        "law_key_points": lawKeyPoints == null
            ? []
            : List<dynamic>.from(lawKeyPoints!.map((x) => x)),
      };
}
...
class RelatedLaw {
  ...
  factory RelatedLaw.fromRawJson(String str) =>
      RelatedLaw.fromJson(json.decode(str));
