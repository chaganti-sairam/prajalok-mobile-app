...
class ClientQueryModel {
  ...
  factory ClientQueryModel.fromRawJson(String str) => ClientQueryModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ClientQueryModel.fromJson(Map<String, dynamic> json) => ClientQueryModel(
        id: json["id"],
...
class Answer {
  ...
  List<OtherImportantInformation>? otherImportantInformation;
  ...
  factory Answer.fromJson(Map<String, dynamic> json) => Answer(
        ...
        otherImportantInformation: json["other_important_information"] == null
            ? []
            : List<OtherImportantInformation>.from(json["other_important_information"]!.map((x) => OtherImportantInformation.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "other_important_information": otherImportantInformation == null ? [] : List<dynamic>.from(otherImportantInformation!.map((x) => x.toJson())),
      };
}
